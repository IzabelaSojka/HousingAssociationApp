!function (a, i) {
    ...
    var a = A.version.split("."), e = +a[0], r = +a[1];
    ...
    function o(a) {
        var i = 0, e = a.split("."), r = e[0], o = e[1] || "", A = 1, c = 0, n = 1;
    ...
    function l(a) {
        ...
        return m(e), m(r), m(o), function (a, i) {
            ...
            a[i - 1] = 1 / 0
        }(o, r.length), {name: i[0], abbrs: f(i[1].split(" "), r), offsets: f(e, r), untils: o, population: 0 | i[5]}
    }
    ...
    function E() {
        ...
        var e, r, o, A = function () {
            ...
            for (i = 0; i < o; i++) for (e in r = u[a[i].offset] || {}) r.hasOwnProperty(e) && (A[e] = !0);
    ...
    function C(a) {
        var i = Array.prototype.slice.call(arguments, 0, -1), e = arguments[arguments.length - 1], r = S(e),
    ...
    (e < 2 || 2 === e && r < 6) && N("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + A.version + ". See momentjs.com"), p.prototype = {
        _set: function (a) {
            ...
            for (o = 0; o < t; o++) if (i = c[o], e = c[o + 1], r = c[o ? o - 1 : o], i < e && C.moveAmbiguousForward ? i = e : r < i && C.moveInvalidForward && (i = r), A < n[o] - 6e4 * i) return c[o];
            return c[t]
        }, abbr: function (a) {
